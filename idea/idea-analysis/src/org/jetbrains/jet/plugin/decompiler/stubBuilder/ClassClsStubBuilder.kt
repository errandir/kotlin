...
private class ClassClsStubBuilder(
    ...
    fun build() {
        val createTypeConstraintListStub = typeStubBuilder.createTypeParameterListStub(classOrObjectStub, classProto.getTypeParameterList())
    ...
    //TODO_R: test annotations on class object
