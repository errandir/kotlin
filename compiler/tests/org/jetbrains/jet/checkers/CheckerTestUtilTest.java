...
public class CheckerTestUtilTest extends JetLiteFixture {
    ...
    private static abstract class TheTest {
        ...
        public void test(@NotNull PsiFile psiFile) {
            ...
            String expectedText = CheckerTestUtil.addDiagnosticMarkersToText(psiFile, CheckerTestUtil.getDiagnosticsIncludingSyntaxErrors(bindingContext, psiFile, null)).toString();
            ...
            List<Diagnostic> diagnostics = CheckerTestUtil.getDiagnosticsIncludingSyntaxErrors(bindingContext, psiFile, null);
